class Space {
    ...
    /**
     * Render method - Draw SVG space
     * Write the HTML for the visual components and attach the HTML to the DOM.
     * These render methods are tied to their associated JavaScript objects by the identifiers.
     */
    drawSVGSpace() {
